...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Blue_Movie_f77dad7a9cc95ded5021_20190201160233_archive.zip';
	const ARCHIVE_SIZE		 = '23913939';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f77dad7-01160233';
	const VERSION			 = '1.3.4';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.4==');
		self::log('----------------------------------------------------');
